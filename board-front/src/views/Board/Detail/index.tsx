...
import { CommentListItem, FavoriteListItem } from 'types/enum/interface';
    ...
    return(
      <div id='board-detail-top'>
        <div className='board-detail-header'>
          <div className='board-detail-title'>{'제목입니다제목입니다제목입니다제목입니다제목입니다'}</div>
        ...
        <div className='board-detail-top-main'>
          <div className='board-detail-main-text'>{'본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용본문내용'}</div>
          <img className='board-detail-main-image' src='https://image.edaily.co.kr/images/photo/files/NP/S/2023/05/PS23050400683.jpg'></img>
        </div>
      </div>
    );
  }
     ...
     <div id='board-detail-bottom'>
      ...
      <div className='board-detail-bottom-comment-box'>
        <div className='board-detail-bottom-comment-container'>
          <div className='board-detail-bottom-comment-title'>{'댓글'}<span className='emphasis'>{1}</span></div>
