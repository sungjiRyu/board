...
export default function Authentication() {
  ...
  const SignUpCard = () => {
    ...
    const [isAgreePersonalError, setAgreedPersonalError] = useState<boolean>(false)
        ...
        <div className='auth-card-box'>
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-consent-box'>
              ...
              <div className={isAgreePersonalError ? 'auth-consent-title-error' : 'auth-consent-title'}>{'개인정보동의'}</div>
